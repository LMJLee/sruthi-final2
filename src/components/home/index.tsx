...
const Home = ({ setSelectedPage }: PageProps) => {
	...
	return (
		<section id="home" className="gap-16 bg-primary-100 py-10 md:h-full md:pb-0">
			...
			<motion.div className="md:flex py-20 mx-auto w-5/6 items-center justify-center md:h-5/6" onViewportEnter={() => setSelectedPage(SelectedPage.Home)}>
				{/* MAIN HEADER */}
				<div className="mt-52">
					<motion.div
						className="md:-mt-20"
					...
					>
						<div className="relative">
							<div className="py-10 before:absolute before:-top-20 before:-left-20 before:z-[-1] ">
								<Image alt="home-page-text" height={500} width={500} src={Logo.src} className="home-image" />
							</div>
						</div>
					</motion.div>
				</div>
